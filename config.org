...
(after! eglot
  (setq eglot-events-buffer-size 0    ;; don't log all LSP traffic (reduces GC pressure)
        ...
        eglot-stay-out-of '(imenu)    ;; don't override imenu with sync documentSymbol;
                                      ;; avoids redisplay/menubar freezes when R LS is slow
                                      ;; (e.g. under heavy CPU load from simulations).
                                      ;; xref/M-./completion/workspace-symbol still use LSP.
